			...
			<center>
			 <div class="form-title-row">
               <h1>Welcome <?php echo $username?> </h1>
                 ...
                 <input type="submit" name="add_nonpayer" value="Add Non Payer" style="background: #6caee0; color: white;font-weight: bold;"><br><br>
               ...
               <input type="submit" name="view_toll" value="View Toll Collection" style="background: #6caee0; color: white;font-weight: bold;"><br><br>
                ...
                <input type="submit" name="wallet" value="Wallet Funding" style="background: #6caee0; color: white;font-weight: bold;"><br/><br/>
